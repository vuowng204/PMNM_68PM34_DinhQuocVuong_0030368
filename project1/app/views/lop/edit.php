...
<div class="form-container">
    ...
    <form action="../../lop/update/<?php echo urlencode($lophoc['Malop']); ?>" method="POST">
        <div class="form-group">
            <label for="Malop">Mã Lớp Học (Không thể thay đổi)</label>
            <input type="text" id="Malop" name="Malop" 
                   value="<?php echo htmlspecialchars($lophoc['Malop']); ?>" 
                   readonly style="background-color: #f1f5f9; color: #64748b; border-color: #cbd5e1; cursor: not-allowed;">
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" id="tenlop" name="tenlop" placeholder="Ví dụ: Lập trình Web, Cơ sở dữ liệu..." 
                   ...
                   value="<?php echo htmlspecialchars($lophoc['tenlop']); ?>" required>
        ...
        <div class="form-group">
            ...
            <textarea id="ghichu" name="ghichu" rows="4" placeholder="Ví dụ: Bắt buộc học phần chuyên ngành, Tự chọn, v.v..."
                      class="<?php echo isset($errors['ghichu']) ? 'is-invalid' : ''; ?>"><?php echo htmlspecialchars($lophoc['ghichu'] ?? ''); ?></textarea>
